# coding: utf-8
from simpleai.search.models import Problem
...
from simpleai.search.csp import CspProblem, backtrack, min_conflicts, MOST_CONSTRAINED_VARIABLE, HIGHEST_DEGREE_VARIABLE, LEAST_CONSTRAINING_VALUE
